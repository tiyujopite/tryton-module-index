    ...
    newTags() {
      ...
      for (let module of this.modules) {
        for (let tag of module.tags) {
          console.log(tag)
          console.log(this.tagsOriginal.includes(tag))
...
<template>
  <div class="w-full max-w-6xl ml-auto mr-auto rounded-lg flex flex-col gap-2 border border-gray-200 p-2 my-2">
    ...
    <div class="w-full rounded-lg border border-gray-200 px-2">
      <h2 translate="no" class="text-2xl font-bold m-2">Improve this website</h2>
      <div class="m-2">
    ...
    <div class="w-full rounded-lg border border-gray-200 p-2">
      <h2 translate="no" class="text-2xl font-bold ml-2 mb-2">Add modules</h2>
      <div class="m-2">
